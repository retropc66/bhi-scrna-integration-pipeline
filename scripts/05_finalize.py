...
EMBEDDINGS_DIR = f"{BASEDIR}/output/embeddings"
OUTPUT_DIR = f"{BASEDIR}/output/anndata"
# Analysis parameters
UMAP_MIN_DIST = 0.3
...
print(f" Loading raw data: {RAW_H5AD}")
...
print(f"\nContents:")
print(f"   X: Normalized, log-transformed counts ({adata.n_obs:,} Ã— {adata.n_vars:,})")
